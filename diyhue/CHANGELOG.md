...
## [2.0.35 - 9.9.2026]
### fix
    - fix addon install: use `apk add --no-cache` only (no upgrade / -u)

## [2.0.34 - 9.9.2026]
### fix
    - fix Dockerfile ENV syntax (`key=value`)
    - fix addon install: `apk upgrade --available` before alpine-sdk/openssl
